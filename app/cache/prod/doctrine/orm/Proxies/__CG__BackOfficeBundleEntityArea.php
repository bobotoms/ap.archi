 ...
 */
class Area extends \BackOfficeBundle\Entity\Area implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'BackOfficeBundle\\Entity\\Area' . "\0" . 'id', 'name', 'description', 'countrys', 'slider', 'map', 'markers', '' . "\0" . 'BackOfficeBundle\\Entity\\Area' . "\0" . 'gallery');
        }
