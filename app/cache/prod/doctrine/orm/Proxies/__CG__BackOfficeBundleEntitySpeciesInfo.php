 ...
 */
class SpeciesInfo extends \BackOfficeBundle\Entity\SpeciesInfo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'BackOfficeBundle\\Entity\\SpeciesInfo' . "\0" . 'id', 'title', 'text', 'picture', 'species');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SpeciesInfo $proxy) {
