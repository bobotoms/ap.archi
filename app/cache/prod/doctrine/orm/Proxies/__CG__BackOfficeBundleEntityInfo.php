 ...
 */
class Info extends \BackOfficeBundle\Entity\Info implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'BackOfficeBundle\\Entity\\Info' . "\0" . 'id', 'description', 'package', 'type');
        }
