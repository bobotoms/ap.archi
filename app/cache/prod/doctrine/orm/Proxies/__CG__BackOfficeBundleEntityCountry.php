 ...
 */
class Country extends \BackOfficeBundle\Entity\Country implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'BackOfficeBundle\\Entity\\Country' . "\0" . 'id', 'name', 'destinations', 'area', 'spots', 'description', 'slider', 'map', '' . "\0" . 'BackOfficeBundle\\Entity\\Country' . "\0" . 'gallery');
        }
    ...
    public function setDestinations($destinations)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDestinations', array($destinations));
    ...
    public function getDestinations()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDestinations', array());
