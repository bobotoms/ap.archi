 ...
 */
class Desire extends \BackOfficeBundle\Entity\Desire implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'BackOfficeBundle\\Entity\\Desire' . "\0" . 'id', 'name', 'pictogram', 'picture', 'products');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Desire $proxy) {
