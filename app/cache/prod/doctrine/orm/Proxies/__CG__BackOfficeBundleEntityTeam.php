 ...
 */
class Team extends \BackOfficeBundle\Entity\Team implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'BackOfficeBundle\\Entity\\Team' . "\0" . 'id', 'firstName', 'lastName', 'office', 'products', '' . "\0" . 'BackOfficeBundle\\Entity\\Team' . "\0" . 'picture', 'spots');
        }
