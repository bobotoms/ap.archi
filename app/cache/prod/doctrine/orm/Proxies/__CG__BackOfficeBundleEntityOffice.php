 ...
 */
class Office extends \BackOfficeBundle\Entity\Office implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'BackOfficeBundle\\Entity\\Office' . "\0" . 'id', 'name', 'teams');
        }
