 ...
 */
class Insurance extends \BackOfficeBundle\Entity\Insurance implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'BackOfficeBundle\\Entity\\Insurance' . "\0" . 'id', 'description', 'packages');
        }
