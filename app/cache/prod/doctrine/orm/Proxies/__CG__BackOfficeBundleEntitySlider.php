 ...
 */
class Slider extends \BackOfficeBundle\Entity\Slider implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'BackOfficeBundle\\Entity\\Slider' . "\0" . 'id', 'name', 'slides', 'team', 'listSpecies', 'areas', 'spots', 'countrys');
        }
    ...
    public function setSlides($slides)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSlides', array($slides));

        return parent::setSlides($slides);
    }
    ...
    public function getSlides()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSlides', array());
