...
class __TwigTemplate_d44700ddf86dd8bead94707443ab3057335c670c6d951bf24264bea17eae29aa extends Twig_Template
{
    ...
    {
        $__internal_66d47017b04254dc27491d0f88f3f82b0c151072afb249dccde17032f65ce221 = $this->env->getExtension("Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension");
        $__internal_66d47017b04254dc27491d0f88f3f82b0c151072afb249dccde17032f65ce221->enter($__internal_66d47017b04254dc27491d0f88f3f82b0c151072afb249dccde17032f65ce221_prof = new Twig_Profiler_Profile($this->getTemplateName(), "template", "@SonataAdmin/CRUD/Association/edit_one_to_many.html.twig"));
            ...
            if (($this->getAttribute((isset($context["sonata_admin"]) ? $context["sonata_admin"] : $this->getContext($context, "sonata_admin")), "edit", array()) == "inline")) {
                ...
                if (($this->getAttribute((isset($context["sonata_admin"]) ? $context["sonata_admin"] : $this->getContext($context, "sonata_admin")), "inline", array()) == "table")) {
                    ...
                    if ((twig_length_filter($this->env, $this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "children", array())) > 0)) {
                        // line 22
                        echo "                        ";
                        $this->loadTemplate("SonataAdminBundle:CRUD/Association:edit_one_to_many_inline_table.html.twig", "@SonataAdmin/CRUD/Association/edit_one_to_many.html.twig", 22)->display($context);
                        // line 23
                        echo "                    ";
                    }
                    // line 24
                    ...
                    // line 26
                    echo "                    ";
                    $this->loadTemplate("SonataAdminBundle:CRUD/Association:edit_one_to_many_inline_tabs.html.twig", "@SonataAdmin/CRUD/Association/edit_one_to_many.html.twig", 26)->display($context);
                    // line 27
                    echo "
                ";
                }
...
(isset($context["sonata_admin"]) ? $context["sonata_admin"] : $this->getContext($context, "sonata_admin")), "field_description", array()), "getOption", array(0 => "link_parameters", 1 => array()), "method")), "method"), "html", null, true);
            ...
            ";
                ...
                if ($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["sonata_admin"]) ? $context["sonata_admin"] : null), "field_description", array(), "any", false, true), "options", array(), "any", false, true), "sortable", array(), "any", true, true)) {
                    ...
                    if (($this->getAttribute((isset($context["sonata_admin"]) ? $context["sonata_admin"] : $this->getContext($context, "sonata_admin")), "inline", array()) == "table")) {
                        // line 65
                        echo "                    ";
                        $this->loadTemplate("SonataAdminBundle:CRUD/Association:edit_one_to_many_sortable_script_table.html.twig", "@SonataAdmin/CRUD/Association/edit_one_to_many.html.twig", 65)->display($context);
                        // line 66
                        echo "                ";
                    } else {
                        // line 67
                        echo "                    ";
                        $this->loadTemplate("SonataAdminBundle:CRUD/Association:edit_one_to_many_sortable_script_tabs.html.twig", "@SonataAdmin/CRUD/Association/edit_one_to_many.html.twig", 67)->display($context);
                        // line 68
                        echo "                ";
                    }
                    // line 69
            ...
            ";
                // line 72
                echo "            ";
                $this->loadTemplate("SonataAdminBundle:CRUD/Association:edit_one_script.html.twig", "@SonataAdmin/CRUD/Association/edit_one_to_many.html.twig", 72)->display($context);
                // line 73
                echo "
        ";
            } else {
...
(isset($context["sonata_admin"]) ? $context["sonata_admin"] : $this->getContext($context, "sonata_admin")), "field_description", array()), "getOption", array(0 => "link_parameters", 1 => array()), "method")), "method"), "html", null, true);
            ...
            ";
                // line 92
                $this->loadTemplate("SonataAdminBundle:CRUD/Association:edit_modal.html.twig", "@SonataAdmin/CRUD/Association/edit_one_to_many.html.twig", 92)->display($context);
                // line 93
                echo "
            ";
                // line 94
                $this->loadTemplate("SonataAdminBundle:CRUD/Association:edit_one_script.html.twig", "@SonataAdmin/CRUD/Association/edit_one_to_many.html.twig", 94)->display($context);
                // line 95
                echo "        ";
            }
            // line 96
...
";
        ...
        $__internal_66d47017b04254dc27491d0f88f3f82b0c151072afb249dccde17032f65ce221->leave($__internal_66d47017b04254dc27491d0f88f3f82b0c151072afb249dccde17032f65ce221_prof);
...
{% endif %}
", "@SonataAdmin/CRUD/Association/edit_one_to_many.html.twig", "C:\\wamp\\www\\Aparchi\\vendor\\sonata-project\\admin-bundle\\Resources\\views\\CRUD\\Association\\edit_one_to_many.html.twig");
    }
}
