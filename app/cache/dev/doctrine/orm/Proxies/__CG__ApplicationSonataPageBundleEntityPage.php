...
class Page extends \Application\Sonata\PageBundle\Entity\Page implements \Doctrine\ORM\Proxy\Proxy
{
     ...
     * {@inheritDoc}
     */
    public function addBlocks(\Sonata\PageBundle\Model\PageBlockInterface $blocks)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addBlocks', array($blocks));

        return parent::addBlocks($blocks);
    }
